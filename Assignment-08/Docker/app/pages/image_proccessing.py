...
number=int(st.slider("please enter a Percent of blur",min_value=1,max_value=100,value=50,step=2))
uploadimage=st.file_uploader("Select your Image ...",type=["jpg","jpeg","png"])
